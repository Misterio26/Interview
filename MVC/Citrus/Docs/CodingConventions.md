...
// events
// fields
// properties trivial only
// explicit interface properties implimentation
// constructors
// methods
// static methods
// explicit interface methods implimentation
// partial methods
```

- **Всегда**: Инициализируй поля в конструкторе, а не в определении поля
