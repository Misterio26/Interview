...
namespace GeneratedDeserializersBIN
{
	public class BinaryDeserializerGen: BinaryDeserializerGenBase
	{
		...
		{
			var result = (global::Lime.Animator<global::System.SByte>)obj;
			var dg = (BinaryDeserializerGen)d;
			ReaderClassDef.FieldDef fd;
			fd = def.Fields[d.Reader.ReadInt16()];
			if (1 == fd.OurIndex) {
			...
			if (2 == fd.OurIndex) {
				...
				if (tmp1 >= 0) {
					while (--tmp1 >= 0) {
						var tmp2 = (global::Lime.Keyframe<global::System.SByte>)dg.ReadObject<global::Lime.Keyframe<global::System.SByte>>();
						result.ReadonlyKeys.Add(tmp2);
					}
				}
				fd = def.Fields[d.Reader.ReadInt16()];
		...
		{
			var result = new global::Lime.Animator<global::System.SByte>();
		...
		{
			var result = (global::Lime.Keyframe<global::System.SByte>)obj;
			result.Frame = d.Reader.ReadInt32();
			result.PackedParams = d.Reader.ReadInt32();
		...
		{
			var result = new global::Lime.Keyframe<global::System.SByte>();
		...
		static BinaryDeserializerGen()
		{
			...
			readCache[typeof(global::Lime.Animator<global::System.SByte>)] = Read_Lime__Animator_SByte;
			...
			readCache[typeof(global::Lime.Keyframe<global::System.SByte>)] = Read_Lime__Keyframe_SByte;
			...
			makeCache[typeof(global::Lime.Animator<global::System.SByte>)] = Make_Lime__Animator_SByte;
			...
			makeCache[typeof(global::Lime.Keyframe<global::System.SByte>)] = Make_Lime__Keyframe_SByte;
